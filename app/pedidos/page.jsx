...
function PedidosContent() {
  ...
  async function loadOrders() {
    ...
    let query = supabase
      ...
      .select("*, atacarejo_customers(name, email, phone, street, street_number, complement, neighborhood, city, state, zip_code, reference_point), atacarejo_order_items(product_name, unit_price, quantity), atacarejo_deliveries(status, tracking_code, carrier, estimated_date)")
