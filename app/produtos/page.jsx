...
function ProdutosContent() {
  ...
  async function handleDelete(id, name) {
    ...
    await supabase.from("atacarejo_products").delete().eq("id", id);
    loadProducts();
  }

  const zeroStockCount = atacarejo_products.filter((p) => p.stock === 0).length;
      ...
      <div style={styles.content}>
        <div style={styles.header}>
          <div>
            ...
            <p style={styles.subtitle}>{atacarejo_products.length} cadastrados</p>
          </div>
